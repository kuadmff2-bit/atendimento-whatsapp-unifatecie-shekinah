...
async function tentarCorrecoesAtendimento({client,msg,textoOriginal,sessao,responder}){
 ...
 if(perguntaModalidadeUnifatecie(textoOriginal,sessao)){sessao.instituicao="unifatecie";await responder(client,msg.from,"💻 Sim. As aulas são *100% online* e o aluno acessa tudo pelo *portal da UniFatecie*. ✅");return true;}
